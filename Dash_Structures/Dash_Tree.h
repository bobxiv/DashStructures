...
protected:
	...
	_DTree_Node_base(_DTree_Node_base* _right, _DTree_Node_base* _left_child): 
		right(_right), left_child(_left_child){}
...
class _DTree_Node:public _DTree_Node_base{
	...
	_DTree_Node(): data( _Tp() ) ,_DTree_Node_base(NULL,NULL){}
...
public:
	...
	bool operator==( _Tree_Iterator& _B ){
